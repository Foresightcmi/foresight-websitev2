const fs = require('fs');
const file = 'app/components/AskForesightWidget.js';
...
content = content.replace(/agent-avatar-loop\.mp4/g, 'videos/chris-avatar-real.mp4');
fs.writeFileSync(file, content);
console.log('Replaced widget video paths.');
