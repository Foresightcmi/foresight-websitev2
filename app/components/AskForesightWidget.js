...
export default function AskForesightWidget() {
  ...
  const generateAIResponse = (userText) => {
    ...
    if (matchesAny(['report', 'reports', 'sample'])) {
      ...
      response = "Standard resale home inspections start at $315, new builds at $355. Specialized audits: Short-Term Rental (STR) Compliance Assist starts at $275. Add-ons: Termites ($125+), Radon ($200), Pool ($275), Sewer scope ($400). Note: Stacking $75 complexity fees apply if the home is 50+ years old, has a crawlspace, or an unfinished basement. These complexity fees are bypassed entirely for STR audits! Drones and thermal imaging are included free!";
    } else {
