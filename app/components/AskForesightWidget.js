...
export default function AskForesightWidget() {
  ...
  const generateAIResponse = (userText) => {
    ...
    if (matchesAny(['report', 'reports', 'sample'])) {
      ...
      response = "Standard resale home inspections, pre-listing seller inspections, and 11-month builder warranty audits all start at $415. New construction dual-phase checks start at $565 (which includes both pre-drywall and final walkthrough audits). Specialized audits: Short-Term Rental (STR) Compliance Assist starts at $275. Add-ons: Termites ($125+), Radon ($200), Pool ($275), Sewer scope ($400). Note: Additional complexity fees of $75 apply for each condition present (being 50+ years old, crawlspace, or unfinished basement) and stack per condition (e.g. a 50+ year old home on a crawlspace adds $150). These fees are bypassed for STR audits! Drones and thermal imaging are included free!";
    } else {
