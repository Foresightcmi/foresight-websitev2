...
export default function AskForesightWidget() {
  ...
  const generateAIResponse = (userText) => {
    ...
    if (matchesAny(['report', 'reports', 'sample'])) {
      ...
      response = "Standard resale home inspections start at $315, new builds at $355. Add-ons: Termites ($125+), Radon ($175), Pool ($275), Sewer scope ($400). Note: Stacking $75 complexity fees apply if the home is 50+ years old, has a crawlspace, or an unfinished basement. Drones and thermal imaging are included free!";
    } else {
