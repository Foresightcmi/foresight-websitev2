...
export default function AskForesightWidget() {
  ...
  const generateAIResponse = (userText) => {
    ...
    if (matchesAny(['report', 'reports', 'sample'])) {
      ...
      response = "Standard buyer home inspections and pre-listing seller inspections start at $295 for condos and $345 for single-family homes. 11-month builder warranty inspections start at $335, and new construction final phase inspections start at $355. Specialized services: STR Compliance Assist starts at $355. Add-ons: Termites ($110 bundled / $150 standalone), Radon ($200), Pool ($300), Sewer scope ($425). Property age surcharges apply ($50 for 25-49 yrs, $95 for 50+ yrs). Foundation complexity fees ($85 crawlspace, $75 unfinished basement). Drones and FLIR thermal imaging are included standard on every job!";
    } else {
