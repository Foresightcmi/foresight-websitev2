...
export default function AskForesightWidget() {
  ...
  const generateAIResponse = (userText) => {
    ...
    if (matchesAny(['report', 'reports', 'sample'])) {
      ...
      response = "Surrounding Atlanta counties require active Short-Term Rental (STR) compliance safety checks for Airbnb/Vrbo hosts. We offer standard safety compliance audits starting at $355 to verify smoke and CO detectors, fire extinguishers, exit route safety, and required entryway signage. Pricing starts at $355 and we adjust tailored quotes based on property scale and location because every county's rules are slightly different. Contact us for your specific county checklist!";
      ...
      response = "Standard resale home inspections and pre-listing seller inspections start at $420. 11-month builder warranty audits and new construction final walkthroughs start at $375. Specialized audits: Short-Term Rental (STR) Compliance Assist starts at $355. Add-ons: Termites ($110 bundled / $150 standalone), Radon ($200), Pool ($135 bundled / $175 standalone), Sewer scope ($400). Note: Additional complexity fees of $75 apply for each foundation complexity present (having a crawlspace or unfinished basement) and stack. These fees are bypassed for STR audits! Drones and thermal imaging are included free!";
    } else {
