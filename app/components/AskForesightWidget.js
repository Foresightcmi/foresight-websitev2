...
export default function AskForesightWidget() {
  ...
  const generateAIResponse = (userText) => {
    ...
    if (matchesAny(['report', 'reports', 'sample'])) {
      ...
      response = "Mistakes happen fast on new builds and get hidden by drywall. We recommend a final walkthrough inspection. 🔍 Observation: Disconnected HVAC duct. 💡 What This Could Mean: Skyrocketing energy bills. 🛠️ Recommendation: Builder HVAC correction. Secure repairs before closing!";
