...
export default function AskForesightWidget() {
  ...
  const generateAIResponse = (userText) => {
    ...
    if (matchesAny(['report', 'reports', 'sample'])) {
      ...
      response = "Georgia is prime subterranean termite country. We partner with top-tier licensed pest control specialists to provide an Official Georgia Wood Infestation Report. 🔍 Observation: Active mud tubes. 💡 What This Could Mean: Wood structural damage. 🛠️ Recommendation: Licensed pest operator. This check saves you massive structural repair costs down the road!";
    } else if (matchesAny(['pool', 'pools', 'spa', 'spas'])) {
      response = "We inspect pool structures, barriers, pumps, filters, heaters, and electrical GFCI safety. 🔍 Observation: GFCI light breaker failure. 💡 What This Could Mean: Shock hazard. 🛠️ Recommendation: Licensed electrician. Catching pump or heater defects early lets you negotiate credits of $2,500 to $5,000!";
      ...
      response = "Mistakes happen fast on new builds and get hidden by drywall. We recommend a Pre-Drywall or Final walkthrough check. 🔍 Observation: Disconnected HVAC duct. 💡 What This Could Mean: Skyrocketing energy bills. 🛠️ Recommendation: Builder HVAC correction. Secure repairs before closing!";
      ...
      response = "Surrounding Atlanta counties require active Short-Term Rental (STR) compliance safety checks for Airbnb/Vrbo hosts. We offer standard safety compliance audits starting at $275 to verify smoke and CO detectors, fire extinguishers, exit route safety, and required entryway signage. Pricing starts at $275 and we adjust tailored quotes based on property scale and location because every county's rules are slightly different. Contact us for your specific county checklist!";
    } else if (matchesAny(['price', 'pricing', 'cost', 'quote'])) {
      response = "Standard resale home inspections start at $315, new builds at $355. Specialized audits: Short-Term Rental (STR) Compliance Assist starts at $275. Add-ons: Termites ($125+), Radon ($175), Pool ($275), Sewer scope ($400). Note: Stacking $75 complexity fees apply if the home is 50+ years old, has a crawlspace, or an unfinished basement. These complexity fees are bypassed entirely for STR audits! Drones and thermal imaging are included free!";
    } else {
