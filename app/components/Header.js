    ...
    <header className="header glass">
      <div className="container nav-container">
        <Link href="/" className="logo">
          <Image src="/images/logo.jpg" alt="Foresight Home Inspections - Certified Master Inspector in Atlanta GA" width={300} height={180} style={{ height: '140px', width: 'auto' }} priority />
