              ...
              {submitStatus === 'success' ? (
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                  ...
                  <div style={{ 
                    ...
                    ℹ️ <strong>Tentative Inquiries &amp; Requests:</strong> All online contact submissions are tentative requests. Our office reviews property details and contacts you within 2 hours to confirm availability. To solidify all appointments on our calendar, a 50% deposit is required, with the remaining 50% balance due upon inspection completion before report release. Sunday is strictly by appointment only. Auxiliary services (Pool, Termite, Radon, Sewer Scope) are scheduled and coordinated alongside your primary inspection.
                  </div>
