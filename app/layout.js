            ...
            <div className="footer-grid">
              <div>
                ...
                <div className="footer-socials">
                  ...
                  <a href="https://maps.google.com/?cid=10862078652033010531" target="_blank" rel="noopener noreferrer" aria-label="Google Business Profile" className="footer-social-link" title="Google Business Profile">
                    <svg viewBox="0 0 24 24" fill="currentColor">
                      <path d="M12 0C7.03 0 3 4.03 3 9c0 5.25 7 13 9 15 2-2 9-9.75 9-15 0-4.97-4.03-9-9-9zm0 12c-1.66 0-3-1.34-3-3s1.34-3 3-3 3 1.34 3 3-1.34 3-3 3z"/>
                    </svg>
                  </a>
                </div>
              </div>
