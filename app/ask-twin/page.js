...
export default function AskTwin() {
  ...
  const generateAIResponse = (userText) => {
    ...
    if (matchesAny(['two', 'team', 'dual', 'inspectors', 'pair'])) {
      ...
      response = "Radon is an invisible, odorless radioactive gas released from Georgia granite soils. We deploy 48-hour continuous electronic radon monitors following strict EPA protocols ($250 flat rate). 🔍 Observation: Radon levels above 4.0 pCi/L. 💡 What This Could Mean: Severe long-term respiratory health hazard. 🛠️ Recommendation: Certified radon mitigation contractor. Finding radon gives you the leverage to require the seller to install a $1,500 to $2,500 mitigation system on their dime before closing!";
    } else if (matchesAny(['termite', 'termites', 'bug', 'bugs', 'pest', 'wdo', 'infestation'])) {
      response = "Georgia is prime territory for subterranean termites, which can chew through structural floor joists and studs silently. We perform a complete wood-destroying organism inspection ($125+ bundled rate, $165 for crawlspaces) and provide the Official Georgia Wood Infestation Report. 🔍 Observation: Active mud tubes. 💡 What This Could Mean: Active structural wood damage. 🛠️ Recommendation: Licensed pest control operator. This check saves you thousands in catastrophic framing repairs.";
    } else if (matchesAny(['pool', 'pools', 'spa', 'spas', 'swimming'])) {
      response = "A swimming pool is a wonderful luxury, but faulty pumps, heaters, or underwater lighting can cost $3,000 to $5,000 to replace or create severe shock hazards. We offer a comprehensive Pool & Spa safety and mechanical inspection ($275 flat rate). 🔍 Observation: Pool light GFCI breaker fails to trip. 💡 What This Could Mean: Direct electrocution risk to swimmers. 🛠️ Recommendation: Licensed electrical contractor. Our pool inspection gives you the leverage to get seller repair credits before closing!";
    } else if (matchesAny(['sewer', 'sewer scope', 'drain line', 'pipe camera'])) {
      response = "Replacing a collapsed underground sewer line or fixing tree root intrusion costs $8,000 to $15,000 out of pocket. Our high-definition Sewer Scope Camera inspection ($450 flat rate) runs a specialized optic camera from your cleanout all the way to the municipal main, verifying the pipe is free of root intrusion, belly dips, or cracked clay. A vital check for homes over 25 years old!";
    } else if (matchesAny(['warranty', 'warranties', '11-month', '11 month'])) {
      response = "Our 11-Month Warranty Inspection ($335+) gives you an independent builder-ready punch list before your 1-year builder coverage expires. 🔍 Observation: Settled grading causing water to pool against foundation walls. 💡 What This Could Mean: Crawlspace moisture and foundation shift. 🛠️ Recommendation: Builder grading correction under warranty. Forces the builder to fix defects on their dime, saving you thousands!";
