  ...
  const generateAIResponse = (userText) => {
    ...
    if (matchesAny(['report', 'reports', 'sample', 'format', 'structure'])) {
      ...
      response = "We believe in honest, transparent pricing based on the actual size and age of your home. Standard resale home inspections start at $315, pre-listing seller checks at $365, new builds at $355, and 11-month builder warranty audits at $335.\n\n" +
                 ...
                 "- **Short-Term Rental (STR) Compliance Assist**: Starts at **$275** based on property size, location, and county rules.\n" +
                 ...
                 "Note: An additional **$75 complexity fee** applies to single-family home inspections for each of the following conditions present: if the property is 50+ years old, has a crawlspace, or has an unfinished/partial basement. These fees stack per condition (e.g., if a home is 50+ years old AND has a crawlspace, the complexity fee is $150). Host STR compliance audits bypass these complexity fees entirely!\n\n" +
