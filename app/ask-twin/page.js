  ...
  const generateAIResponse = (userText) => {
    ...
    if (matchesAny(['report', 'reports', 'sample', 'format', 'structure'])) {
      ...
      response = "Georgia is prime country for termites. In our warm, damp climate, subterranean termites are highly active and can chew through structural wood studs silently for years without you ever knowing.\n\n" +
                 "At Foresight, we partner with top-tier licensed pest control specialists to provide a thorough wood-destroying organism (WDO) inspection alongside our standard check. You'll get an Official Georgia Wood Infestation Report, which mortgage lenders often require anyway.\n\n" +
      ...
      response = "A brand-new home? Congratulations! But let me tell you a secret from a seasoned pro: *never* skip an inspection on a new build. I hear folks say, 'Why inspect it? It's brand new and the city code inspector signed off!' Well, city inspectors are overloaded—they might spend 15 minutes on a house. Subcontractors are working fast, and mistakes get covered up by fresh drywall.\n\n" +
                 ...
                 "Having us perform an independent inspection on a new build saves you more money in the long run than almost anything else. We've saved our clients thousands of dollars in out-of-pocket repairs by arming them with the report they need to force the builder to make upfront repairs on *their* dime before closing, rather than leaving you stuck with the bills later. Let's get our dual-inspector team out there for a Pre-Drywall framing check or a Final Walkthrough. Get an instant quote to secure your slot!";
    ...
    } else if (matchesAny(['str', 'airbnb', 'vrbo', 'dekalb', 'compliance', 'short term', 'short-term', 'municipality', 'county', 'ordinance', 'framework'])) {
      response = "Well now, let's talk about short-term rentals—Airbnb, Vrbo, and all the rest. Local governments are stepping up their game to keep things safe and orderly, and here in Metro Atlanta, DeKalb County is leading the charge with **Ordinance TA-24-1246762**. Whether you're an individual investor looking to get licensed or a county commissioner needing to build a custom ruleset, we've got you covered from top to bottom.\n\n" +
                 "### 🏡 For Individual Hosts & Operators\n" +
                 "If you're trying to get your host permit approved on the DeKalb portal, do not risk getting shut down or paying a **non-refundable $175 license application fee** on a property that isn't even allowed to operate. We pre-screen for historic district exclusions to save you that cash! Under Ordinance TA-24-1246762, we provide a complete certified audit package:\n\n" +
                 "1. 🚗 **Mandatory Parking Site Plan**: A professional, scaled drawing of designated off-street parking spaces. The county will reject your application without this!\n" +
                 "2. 👥 **Legal Occupancy Mapping**: Official certification of maximum occupancy limits (2 guests per guest room + 2 additional, absolute cap of 10) to protect you from heavy over-occupancy fines.\n" +
                 "3. 🛡️ **Life-Safety Verification**: Certified testing and placement checks of smoke detectors (one per level and inside every sleeping area) and carbon monoxide alarms.\n" +
                 "4. 🧯 **Fire Safety Equipment**: Checking for a visible, accessible fire extinguisher (at least one per level).\n" +
                 "5. 🚪 **Local Agent & Signage Checks**: Verifying the mandatory 24-hour local contact info is posted visibly on-site.\n\n" +
                 "Our **Base STR Compliance Package** runs **$275 – $350** (best for condos/homes under 2,500 sq. ft.), and our **Premium \"Investor-Grade\" Audit** is **$450+** for larger estates or multi-unit portfolios.\n\n" +
                 "🔍 **Observation**: Smoke alarms in the second-floor bedrooms were missing, and the parking site plan was missing the scaled designations.\n" +
                 "💡 **What This Could Mean**: You face immediate rejection in the DeKalb portal, loss of your non-refundable $175 filing fee, or heavy fines for running an uncertified rental.\n" +
                 "🛠️ **Recommendation**: Have us run a complete dual-inspector host audit to draw your parking plan and verify every safety system before you submit.\n\n" +
                 "---\n\n" +
                 "### 🏛️ For Municipalities & Counties\n" +
                 "If you're a city or county leader looking to balance housing availability with tourism, our **STR Compliance Framework Implementation** is completely modular and built to suit your zoning goals. We don't just dump code on you; we implement a robust 3-tier regulatory architecture:\n\n" +
                 "- **Tier 1: The \"Starter / Rural\" Tier**: Target: Small counties or startup host alliances under 100 active STRs. Includes: standard turnkey ordinance template, basic software onboarding, and standard email support.\n" +
                 "- **Tier 2: The \"Standard / Suburban\" Tier**: Target: Mid-sized counties needing a balance of regulation and enforcement. Includes: the universal framework, customized local responder/parking modules, tax collection setup advice, and monthly compliance reporting.\n" +
                 "- **Tier 3: The \"Enterprise / High-Density\" Tier** (Custom Quote Only): Target: Major tourist destinations, large urban counties, or massive property management portfolios. Includes: full software integration, active 24/7 hotline management, legal review of custom amendments, and dedicated account management.\n\n" +
                 "Three primary variables shift the framework price, keeping things totally transparent: **property volume** (managing 50 vs. 5,000 units), the **level of legal customization** (out-of-the-box templates vs. heavy local rewriting), and **add-on services** (like scanning Airbnb/Vrbo weekly to catch unregistered hosts). Let's protect your jurisdiction's tax base—which includes setting up that crucial 8% hotel-motel tax—while keeping neighbors happy!\n\n" +
                 "Are you ready to schedule your host compliance audit, or would you like to get in touch with our government advisory team for a municipal quote?";
      ...
      response = "We believe in honest, transparent pricing based on the actual size and age of your home. Standard resale home inspections start at $315, pre-listing seller checks at $365, new builds at $355, and 11-month builder warranty audits at $335.\n\n" +
                 ...
                 "- **Short-Term Rental (STR) Host Compliance Audit**: **$275 – $350** for Base STR Compliance (condos & homes under 2,500 sq. ft.) and **$450+** for Premium Investor-Grade.\n" +
                 "- **STR Compliance Framework Implementation**: **Modular Government Consulting** starting per jurisdiction (Tier 1 Rural, Tier 2 Suburban, Tier 3 Enterprise Custom Quote).\n" +
                 ...
                 "Note: An additional **$75 complexity fee** applies to single-family home inspections for each of the following conditions present: if the property is 50+ years old, has a crawlspace, or has an unfinished/partial basement. These fees stack per condition (e.g., if a home is 50+ years old AND has a crawlspace, the complexity fee is $150). Host STR audits bypass these complexity fees entirely!\n\n" +
      ...
      response = "That is an excellent question! Houses are complex systems—what happens in the attic affects the basement, and what happens outside affects the inside. Under InterNACHI standards, we look at how all these systems interact to protect your investment.\n\n" +
                 "While I can give you general advice, the absolute best thing you can do is have our dual-inspector team perform a physical, high-tech walkthrough of the home. Getting us to perform a physical inspection is going to save you so much money in the long run. Time and again, we've saved our clients thousands of dollars on their purchases. We hand you a clear, itemized report with photos and video that you can use to negotiate upfront repairs from the seller or win major repair credits at the closing table. The inspection fee is a tiny drop in the bucket compared to what you stand to save!\n\n" +
