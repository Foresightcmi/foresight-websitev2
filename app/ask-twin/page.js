...
export default function AskTwin() {
  ...
  const generateAIResponse = (userText) => {
    ...
    if (matchesAny(['report', 'reports', 'sample', 'format', 'structure'])) {
      ...
      response = "We believe in honest, transparent pricing based on the actual size and age of your home. Standard resale home inspections, pre-listing seller checks, and 11-month builder warranty audits all start at $415. New construction dual-phase audits start at $565 (which includes both pre-drywall framing and final inspections).\n\n" +
