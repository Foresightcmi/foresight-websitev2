...
export default function AskTwin() {
  ...
  const generateAIResponse = (userText) => {
    ...
    if (matchesAny(['report', 'reports', 'sample', 'format', 'structure'])) {
      ...
      response = "We believe in honest, transparent pricing based on the actual size and age of your home. Standard resale home inspections start at $415, pre-listing seller checks at $465, new builds at $455, and 11-month builder warranty audits at $435.\n\n" +
                 ...
                 "Note: A single flat $75 complexity fee applies to single-family home inspections if any of the following conditions are present: if the property is 50+ years old, has a crawlspace, or has an unfinished/partial basement. This complexity fee does not stack (e.g., if a home is 50+ years old AND has a crawlspace, the complexity fee is a flat $75). Host Short-Term Rental (STR) compliance audits bypass these complexity fees entirely!\n\n" +
