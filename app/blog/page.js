        ...
        <div className="container">
          <div className="grid grid-2">
            <div className="card">
              ...
              <Link href="/ask-twin" style={{ fontWeight: 600, color: 'var(--color-red)' }}>Ask Foresight AI about New Builds →</Link>
            </div>
            ...
            <div className="card">
              ...
              <Link href="/ask-twin" style={{ fontWeight: 600, color: 'var(--color-red)' }}>Ask Foresight AI about Radon →</Link>
            </div>
            ...
            <div className="card">
              ...
              <Link href="/ask-twin" style={{ fontWeight: 600, color: 'var(--color-red)' }}>Ask Foresight AI about Thermal Tech →</Link>
            </div>
            ...
            <div className="card card-premium" style={{ background: 'var(--color-dark)', color: 'var(--color-white)' }}>
              ...
              <p style={{ color: 'var(--color-gray-mid)', marginBottom: '1.5rem' }}>
                Foresight AI is trained on InterNACHI standards and is available 24/7 to answer your specific home inspection questions.
              </p>
