          ...
          <div className="grid grid-2" style={{ alignItems: 'center' }}>
            ...
            <div style={{ padding: '0 2rem' }}>
              ...
              <p style={{ marginBottom: '1.5rem', fontSize: '1.05rem', color: 'var(--color-gray-dark)', lineHeight: 1.7 }}>
                Christopher Boykin founded Foresight Home Inspections, LLC with a clear mission: to give every home buyer and seller the most detailed, transparent, and technology-driven inspection in Metro Atlanta. With <strong>over a decade of hands-on residential inspection experience</strong>, Christopher has personally inspected thousands of properties across the greater Atlanta area.
              </p>
              <p style={{ marginBottom: '1.5rem', fontSize: '1.05rem', color: 'var(--color-gray-dark)', lineHeight: 1.7 }}>
                In <strong>September 2024</strong>, Christopher earned the prestigious <strong>Certified Master Inspector (CMI)</strong> designation &mdash; the highest professional credential awarded by the Master Inspector Certification Board. This distinction is reserved for inspectors who have completed at least 1,000 paid inspections or equivalent hours of verified education, maintain an impeccable professional record, and adhere strictly to the InterNACHI Standards of Practice.
              </p>
              <p style={{ marginBottom: '1.5rem', fontSize: '1.05rem', color: 'var(--color-gray-dark)', lineHeight: 1.7 }}>
